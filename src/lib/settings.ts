...
export const SETTINGS = {
  ...
  recycleBinRetentionDays: { default: 30, type: 'number', label: '回收站保留天数', group: '回收站', desc: '回收站内文件保留的天数，过期自动清除', keywords: ['回收站', '保留', '天数', 'retention', '清理'], section: 'data', ui: false, scope: 'global', level: 'normal', affects: 'live', min: 1, max: 3650, step: 1, unit: '天' },
  ...
  autoSaveDebounceMs: { default: 2000, type: 'number', label: '自动保存延迟', group: '保存', desc: '停止输入后自动保存的延迟时间（可直接输入毫秒）', keywords: ['自动保存', '保存', '防抖', 'autosave', '延迟', 'debounce'], section: 'editor', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'advanced.autosave', min: 100, max: 30000, step: 100, unit: 'ms' },
  ...
  lockPassword: { default: '', type: 'password', label: '锁屏密码', group: '锁屏', desc: '锁屏密码（留空则点击即可解锁）', keywords: ['锁屏', '密码', 'lock', 'password', '解锁'], section: 'security', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  lockOnStartup: { default: false, type: 'toggle', label: '启动自动锁屏', group: '锁屏', desc: '启动应用后自动进入锁屏', keywords: ['锁屏', '启动', '自动', 'lock'], section: 'security', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  ...
  pluginAllowedLevels: { default: 'S,A,B', type: 'text', label: '插件安全等级', group: '插件安全', desc: '允许安装/启用的插件安全等级（S/A/B 逗号分隔）', keywords: ['插件', '安全', '等级', 'plugin', 'S', 'A', 'B'], section: 'security', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  pluginRequireSignature: { default: false, type: 'toggle', label: '插件强制签名', group: '插件安全', desc: '市场插件强制签名校验', keywords: ['插件', '签名', '校验', 'signature'], section: 'security', ui: false, scope: 'global', level: 'danger', affects: 'live' },
  pluginTrustedKeys: { default: '', type: 'text', label: '受信公钥 keyring', group: '插件安全', desc: '受信签名公钥 keyring（JSON 或 keyId=公钥）', keywords: ['插件', '公钥', 'keyring', '签名', '信任'], section: 'security', ui: false, scope: 'global', level: 'danger', affects: 'live' },
