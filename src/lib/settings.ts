...
export const SETTINGS = {
  ...
  scheduleTimetableRowHeight: { default: 'normal', type: 'select', label: '日程表行高', group: '日程表', desc: '每小时占用的纵向高度（紧凑 / 舒适 / 宽松）', keywords: ['日程表', '行高', '密度', '高度', '紧凑', '宽松', 'timetable', 'rowheight'], section: 'modules', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'schedule.timetableRowHeight' },
