...
export const SETTINGS = {
  ...
  zoom: { default: 1.0, type: 'number', label: '界面缩放', group: '缩放', desc: '整体界面缩放比例（可直接输入百分比）', keywords: ['缩放', 'zoom', '放大', '缩小', '重置', '比例', '界面大小'], section: 'advanced', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'advanced.zoom', min: 85, max: 150, step: 5, unit: '%' },
  markdownDim: { default: true, type: 'toggle', label: 'Markdown 标记淡化', group: '显示', desc: '弱化版所见即所得：编辑时淡化 Markdown 标记，光标行保留原始标记', keywords: ['markdown', '淡化', '标记', 'md', 'dim', '弱化'], section: 'editor', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  exportEncoding: { default: 'utf-8', type: 'select', label: '默认编码', group: '导出', desc: '导出文件的默认字符编码', keywords: ['编码', 'encoding', 'utf', 'utf8', 'utf-8', 'gbk', 'gb2312', 'bom', '乱码'], section: 'export', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'export.encoding' },
  skipDeleteConfirm_blog: { default: false, type: 'toggle', label: '博客删除确认', group: '删除确认', desc: '跳过博客文章删除确认', keywords: ['删除确认', '博客', '跳过', 'confirm'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  skipDeleteConfirm_knowledge: { default: false, type: 'toggle', label: '知识库页面删除确认', group: '删除确认', desc: '跳过知识库页面删除确认', keywords: ['删除确认', '页面', '知识库', '跳过', 'confirm'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  skipDeleteConfirm_knowledgeCategory: { default: false, type: 'toggle', label: '目录/笔记本删除确认', group: '删除确认', desc: '跳过目录/笔记本删除确认', keywords: ['删除确认', '目录', '笔记本', '跳过', 'confirm'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  skipDeleteConfirm_chapter: { default: false, type: 'toggle', label: '章节删除确认', group: '删除确认', desc: '跳过章节删除确认', keywords: ['删除确认', '章节', '跳过', 'confirm'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  trashExportDir: { default: '', type: 'text', label: '回收站导出目录', group: '回收站', desc: '回收站文件导出的目标目录', keywords: ['回收站', '导出', '目录', 'trash', 'export'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  recycleBinRetentionDays: { default: 30, type: 'number', label: '回收站保留天数', group: '回收站', desc: '回收站内文件保留的天数，过期自动清除', keywords: ['回收站', '保留', '天数', 'retention', '清理'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live', min: 1, max: 3650, step: 1, unit: '天' },
  ...
  autoSaveDebounceMs: { default: 2000, type: 'number', label: '自动保存延迟', group: '保存', desc: '停止输入后自动保存的延迟时间（可直接输入毫秒）', keywords: ['自动保存', '保存', '防抖', 'autosave', '延迟', 'debounce'], section: 'advanced', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'advanced.autosave', min: 100, max: 30000, step: 100, unit: 'ms' },
  exportStatusClearMs: { default: 5000, type: 'number', label: '导出成功提示时长', group: '导出', desc: '导出成功提示停留时间', keywords: ['导出', '提示', '停留', 'status', '毫秒'], section: 'export', ui: false, scope: 'global', level: 'normal', affects: 'live', unit: 'ms' },
  skipDeleteConfirm_toolboxScript: { default: false, type: 'toggle', label: '工具箱脚本删除确认', group: '删除确认', desc: '跳过工具箱脚本删除确认', keywords: ['删除确认', '工具箱', '脚本', '跳过'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  lockPassword: { default: '', type: 'password', label: '锁屏密码', group: '锁屏', desc: '锁屏密码（留空则点击即可解锁）', keywords: ['锁屏', '密码', 'lock', 'password', '解锁'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  lockOnStartup: { default: false, type: 'toggle', label: '启动自动锁屏', group: '锁屏', desc: '启动应用后自动进入锁屏', keywords: ['锁屏', '启动', '自动', 'lock'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  zoomMin: { default: 0.85, type: 'number', label: '缩放下限', group: '缩放', desc: '界面缩放下限（约束，勿手改）', keywords: ['缩放', '下限', 'zoom'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  zoomMax: { default: 1.5, type: 'number', label: '缩放上限', group: '缩放', desc: '界面缩放上限（约束，勿手改）', keywords: ['缩放', '上限', 'zoom'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  zoomStep: { default: 0.05, type: 'number', label: '缩放步进', group: '缩放', desc: '界面缩放步进（约束，勿手改）', keywords: ['缩放', '步进', 'zoom'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  ...
  startupTab: { default: 'blog', type: 'select', label: '启动时默认显示', group: '启动', desc: '每次打开应用时自动进入的模块', keywords: ['启动', '默认模块', '首页', 'startup', '默认显示', '初始模块'], section: 'appearance', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'appearance.startupTab' },
  summaryWeeklyDay: { default: 0, type: 'select', label: '周总结日', group: '周期总结', desc: '每周在哪一天生成周总结', keywords: ['周总结', '总结日', '每周', '星期', '周几', 'weekly', '周报'], section: 'blog', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'blog.summaryWeeklyDay' },
  summaryMonthlyMode: { default: 'last', type: 'select', label: '月总结规则', group: '周期总结', desc: '每月总结规则：第一天 / 最后一天 / 固定日', keywords: ['月总结', '总结日', '每月', '月末', '月初', 'monthly', '月报'], section: 'blog', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'blog.summaryMonthlyMode' },
  summaryMonthlyFixedDay: { default: 1, type: 'number', label: '固定日期', group: '周期总结', desc: '固定日模式下，每月哪一天为月总结日', keywords: ['固定日期', '固定日', '几号', '月总结'], section: 'blog', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'blog.summaryMonthlyFixedDay', min: 1, max: 28, step: 1 },
  ...
  checkinReminderEnabled: { default: true, type: 'toggle', label: '启用打卡提醒', group: '打卡提醒', desc: '到点提醒当天未打卡的习惯', keywords: ['打卡', '提醒', '启用', '开关', 'checkin', '通知'], section: 'reminder', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'reminder.enable' },
  checkinReminderTime: { default: '20:00', type: 'time', label: '提醒时间', group: '打卡提醒', desc: '每天触发打卡提醒的时间点', keywords: ['时间', '提醒时间', '几点', '打卡时间', '20:00'], section: 'reminder', ui: true, scope: 'global', level: 'normal', affects: 'live', anchor: 'reminder.time' },
  lanShareAutoStopMinutes: { default: 15, type: 'number', label: '设备传输自动关闭', group: '设备互联', desc: '设备传输无连接自动关闭分钟数', keywords: ['设备传输', '传输', '自动关闭', '超时', 'lanshare'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live', unit: '分钟' },
  onboardingDone: { default: false, type: 'toggle', label: '新手引导完成', group: '引导', desc: '是否已完成新手引导（由引导流程维护）', keywords: ['引导', '新手', 'onboarding'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  ...
  monthlyTokenBudget: { default: 0, type: 'number', label: '月度 token 预算', group: '模型', desc: '月度 token 预算（0=不限）', keywords: ['token', '预算', '额度', 'limit'], section: 'aiTools', ui: false, scope: 'global', level: 'normal', affects: 'live', aiTab: 'models', min: 0, max: 100000000, step: 1000 },
  ...
  dayPanelState: { default: '', type: 'json', label: '日程打卡小窗状态', group: '小窗', desc: '日程打卡小窗位置大小（主进程直写）', keywords: ['小窗', '打卡', 'daypanel', '悬浮'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  wordbookActiveBook: { default: '', type: 'text', label: '当前词书', group: '单词本', desc: '当前学习的词书（空=未选）', keywords: ['词书', '单词', 'wordbook', '背单词'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  wordbookNewPerDay: { default: 10, type: 'number', label: '每日新词数', group: '单词本', desc: '每日建议新学词数', keywords: ['新词', '每日', '单词', 'wordbook'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live', min: 1, max: 100, step: 1 },
  quizbookMode: { default: 'plugin', type: 'select', label: '错题本形态', group: '错题本', desc: '错题本形态：plugin=插件版（默认）/ builtin=内置版（回退）', keywords: ['错题本', '形态', 'quiz', 'plugin', '内置'], section: 'advanced', ui: false, scope: 'global', level: 'experimental', affects: 'reload' },
  storageKnowledge: { default: 'vault', type: 'select', label: '知识库读源', group: '存储', desc: '知识库数据形态：vault=仓库文件（默认）/ sqlite=数据库（过渡期）', keywords: ['读源', '仓库', 'vault', 'sqlite', '去库化', '存储'], section: 'advanced', ui: false, scope: 'global', level: 'experimental', affects: 'reload' },
  storageBlog: { default: 'sqlite', type: 'select', label: '博客数据形态', group: '存储', desc: '博客数据形态：sqlite=数据库（默认）/ vault=仓库文件（灰度验证中）', keywords: ['博客', '存储', 'vault', 'sqlite', '灰度'], section: 'advanced', ui: false, scope: 'global', level: 'experimental', affects: 'reload' },
  storageData: { default: 'sqlite', type: 'select', label: '模块数据形态', group: '存储', desc: '结构化模块数据：sqlite=数据库（默认）/ vault=.knowbase JSON（灰度验证中）', keywords: ['模块', '存储', 'vault', 'sqlite', '灰度'], section: 'advanced', ui: false, scope: 'global', level: 'experimental', affects: 'reload' },
  uiWorkbench: { default: false, type: 'toggle', label: 'Workbench 布局', group: '外壳', desc: '实验性 VS Code 外壳；开启后编辑器文件树移到全局侧栏', keywords: ['workbench', '外壳', '布局', '侧栏', '编辑器组', '状态栏', 'vscode', '活动栏', 'shell', 'layout'], section: 'advanced', ui: true, scope: 'global', level: 'experimental', affects: 'live', anchor: 'advanced.workbench' },
  ...
  pluginAllowedLevels: { default: 'S,A,B', type: 'text', label: '插件安全等级', group: '插件安全', desc: '允许安装/启用的插件安全等级（S/A/B 逗号分隔）', keywords: ['插件', '安全', '等级', 'plugin', 'S', 'A', 'B'], section: 'advanced', ui: false, scope: 'global', level: 'normal', affects: 'live' },
  pluginRequireSignature: { default: false, type: 'toggle', label: '插件强制签名', group: '插件安全', desc: '市场插件强制签名校验', keywords: ['插件', '签名', '校验', 'signature'], section: 'advanced', ui: false, scope: 'global', level: 'danger', affects: 'live' },
  pluginTrustedKeys: { default: '', type: 'text', label: '受信公钥 keyring', group: '插件安全', desc: '受信签名公钥 keyring（JSON 或 keyId=公钥）', keywords: ['插件', '公钥', 'keyring', '签名', '信任'], section: 'advanced', ui: false, scope: 'global', level: 'danger', affects: 'live' },
  updateMirror: { default: 'https://gh-proxy.com', type: 'text', label: '下载镜像', group: '更新', desc: 'GitHub 加速代理前缀，留空直连', keywords: ['镜像', '加速', '代理', 'github', 'proxy', '下载', 'cdn'], section: 'advanced', ui: true, scope: 'global', level: 'normal', affects: 'reload', anchor: 'advanced.mirror' },
}
...
/** 设置页左栏大项（S1 沿用旧 8 项；S2 重排为能力域分组） */
